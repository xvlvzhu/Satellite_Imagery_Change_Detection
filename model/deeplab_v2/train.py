...
from model.deeplab_v2.deeplab_resnet import DeepLabResNetModel, ImageReader, decode_labels, inv_preprocess, prepare_label

# IMG_MEAN = np.array((104.00698793,116.66876762,122.67891434), dtype=np.float32)
IMG_MEAN = np.array((67.91678189,  67.50102065,  61.69442138), dtype=np.float32)

BATCH_SIZE = 5
DATA_DIRECTORY = 'E:/tianchi/preliminary_1/'
DATA_LIST_PATH = './util/train.txt'
IGNORE_LABEL = 142 #255
INPUT_SIZE = '256,256'
