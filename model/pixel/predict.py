...
model_path = "100000model.ckpt"

index_p = 0
index_n = 0

print("Copy end.....")
quickbird2015 = np.load("E:\\tianchi\\20171105_quarterfinals\\quarterfinals_2015.npy").swapaxes(0, 1).swapaxes(1, 2)
quickbird2017 = np.load("E:\\tianchi\\20171105_quarterfinals\\quarterfinals_2017.npy").swapaxes(0, 1).swapaxes(1, 2)
...
all_test_x = tf.placeholder(tf.float32, shape=[None, 5000])
...
with tf.Session() as sess:
    ...
    np.save('E:\\tianchi\\20171026_初赛第二阶段(new)\\out\\out_11_10_drop.npy', np.array(out,dtype=np.uint8).reshape((4000, 15106)))
    print("success.......")
    print(print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())))
